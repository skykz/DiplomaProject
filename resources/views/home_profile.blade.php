        ...
        <div class="col-md-9">
            <div class="profile-content">
                ...
                <form action="{{url('/home/profile/update')}}" method="post" enctype="multipart/form-data">
                    <div class="profile-userpic">
                        <img src="{{asset('storage')}}/{{Auth::user()->avatar}}" class="img-responsive" style="width: 17%;">
                    </div><br>
                    <div class="col-sm-7" style="float: right;margin-right: 170px">
                    {{csrf_field()}}
                        <label> Ваш фото: </label>
                ...
                <input type="email" name="email" value="{{Auth::user()->email}}" class="form form-control"/><br>
                </div><br><br><br><br><br><br><br><br><br><br><br>
                    <hr>
                    <button type="submit" class="btn btn-success" style="box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);"> Обновить </button>
                </form>
